...
export const CreateBarcodeModal: React.FC<CreateBarcodeModalProps> = ({
  ...
  const selectProductItem = useCallback(async (prod: ProductOption, targetVariantId?: string | null) => {
    ...
    const code = prod.barcode || `${barcodePrefix}${Math.floor(1000000 + Math.random() * 9000000)}`
    setItemCode(code)
    setLine1(prod.name)
  ...
  useEffect(() => {
    const codeToRender = (itemCode && itemCode.trim()) || `${barcodePrefix}0000000`
  ...
  const handleAssignCode = () => {
    const generated = barcodePrefix + Math.floor(1000000 + Math.random() * 9000000)
                    ...
                    {(() => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            {itemCode || `${barcodePrefix}0000000`}
                          </span>
